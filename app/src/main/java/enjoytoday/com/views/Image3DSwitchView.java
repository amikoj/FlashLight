...
public class Image3DSwitchView extends ViewGroup {
            ...
            switch (action) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (shouldScrollToNext(velocityX)) {
                        ...
                        // 滚动回当前图片
                        scrollBack();
                        if (Math.abs(y-mLastMotionY)<10f && Math.abs(x-mLastMotionX)<10f){
                            if (this.onImageClickListener!=null){
                                onImageClickListener.onImageClick(mCurrentImage,this);
                            }
                        }
                    }
                    if (mVelocityTracker != null) {
    ...
    public interface  OnImageClickListener{
        void onImageClick(int currentImage, Image3DSwitchView view);
    }
}
